This example shows a sequence of steps to describe and instantiate a device and then send data via https POST requests. All configuration is in the file [config.sh](./config.sh).
